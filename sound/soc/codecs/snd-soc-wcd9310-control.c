...
int tabla_write(struct snd_soc_codec *codec, unsigned int reg, unsigned int value);
...
static struct kobj_attribute sound_control_enabled_attribute =
	__ATTR(gpl_sound_control_enabled, 0666,
